package com.example.topsports.ui.gallery;
...
import com.example.topsports.PieChartFragment;
...
public class GalleryFragment extends Fragment {
    ...
    private void showPieChart(List<SportCount> sportsList) {
        FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
        PieChartFragment pieChartFragment = new PieChartFragment(sportsList);
        transaction.replace(R.id.pie_chart_container, pieChartFragment);
        transaction.commit();
    }
}
